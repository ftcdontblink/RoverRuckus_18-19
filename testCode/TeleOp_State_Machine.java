...
@TeleOp(name="TeleOp_State_Machine", group="Linear Opmode")
// @Disabled
        ...
        while (opModeIsActive()) {
            ...
            switch(ARM_STATE) {
                ...
                case 2:
                    if(gamepad2.a) {
                        onPos = false;
                        pos = ((int) (TICK_PER_DEGREE * 122));  // set pivot to complete horizontal state
                        ARM_STATE = 3;
                    } else if(gamepad2.b) {
                        Extender.setPower(1);                   // extended the arm
                        onPos = false;
                        pos = ((int) (TICK_PER_DEGREE * 0));    // dumping position
                        ARM_STATE = 5;
                    }
                    break;
                ...
                case 3:
                    ...
                    if(Math.abs(Math.abs((Pivot.getCurrentPosition() / TICK_PER_DEGREE)) - 122) < 5) {
                        Extender.setPower(1);                   // extended the arm
                        onPos = false;
                        pos = ((int) (TICK_PER_DEGREE * 158));  // set pivot to mining state
                        ARM_STATE = 4;
                    }
                    break;
                ...
                case 4:
                    if(gamepad2.x) {
                        Extender.setPower(0);                   // retract the arm
                        onPos = false;
